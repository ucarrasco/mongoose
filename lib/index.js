...
Mongoose.prototype.model = function(name, schema, collection, skipInit) {
  ...
  if (schema) {
    ...
    _mongoose._applyPlugins(schema, undefined, name);
  }
...
Mongoose.prototype._applyPlugins = function(schema, options, name) {
  options = options || {};
  options.applyPluginsToDiscriminators = get(this,
    'options.applyPluginsToDiscriminators', false);
  applyPlugins(schema, this.plugins, options, '$globalPluginsApplied', name);
};
